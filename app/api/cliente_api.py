...
from FitZone1.app.respository.cliente_repositories import ClienteRepository, cliente_repository
from FitZone1.app.services.cliente_service import ClienteService
